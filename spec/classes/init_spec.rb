  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      describe 'without any parameters' do
        ...
        if %w[FreeBSD DragonFly].include?(facts[:osfamily])
      ...
      describe 'with all parameters' do
        let(:params) do
          super().merge(
            ...
            includes: %w[myinclude1 myinclude2],
          )
        end
      ...
      describe 'without bootp' do
        ...
        it { is_expected.to compile.with_all_deps }
        it { is_expected.to contain_concat__fragment('dhcp.conf+01_main.dhcp').without_content(%r{allow bootp}) }
      end
